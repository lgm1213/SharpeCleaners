...
class CleanersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cleaner" do
    assert_difference('Cleaner.count') do
      post cleaners_url, params: { cleaner: { email: @cleaner.email, location: @cleaner.location, name: @cleaner.name, phone: @cleaner.phone, username: @cleaner.username } }
    end
  ...
  test "should update cleaner" do
    patch cleaner_url(@cleaner), params: { cleaner: { email: @cleaner.email, location: @cleaner.location, name: @cleaner.name, phone: @cleaner.phone, username: @cleaner.username } }
